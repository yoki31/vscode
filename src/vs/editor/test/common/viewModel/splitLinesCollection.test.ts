...
import { ISimpleModel, ModelLineView, SplitLinesCollection } from 'vs/editor/common/viewModel/splitLinesCollection';
...
function createSplitLine(splitLengths: number[], breakingOffsetsVisibleColumn: number[], wrappedTextIndentWidth: number, isVisible: boolean = true): ModelLineView {
	return new ModelLineView(createLineBreakData(splitLengths, breakingOffsetsVisibleColumn, wrappedTextIndentWidth), isVisible);
}
